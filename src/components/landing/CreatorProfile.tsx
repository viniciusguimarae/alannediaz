...
const CreatorProfile = () => {
  ...
  return (
    <div className="w-full">
      {/* Banner */}
      <div className="w-full h-[120px] bg-gradient-to-br from-primary/80 via-primary/60 to-orange-300 relative" />

      {/* Profile section */}
      <div className="px-5 -mt-10 relative">
        {/* Avatar */}
        <div className="w-20 h-20 rounded-full border-4 border-background bg-gradient-to-br from-primary/40 to-orange-200 overflow-hidden shadow-lg">
          <div className="w-full h-full flex items-center justify-center text-primary-foreground text-xl font-bold" style={{ fontFamily: 'Outfit' }}>
            NC
          </div>
        </div>
